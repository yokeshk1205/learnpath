...
export function getLearningOverview(
  ...
  if (filter.skillId) query.set("skillId", filter.skillId);
  const suffix = query.size ? `?${query.toString()}` : "";
  return apiRequest<LearningOverview>(`/learning/overview${suffix}`, {
...
export function getLearningResource(
  ...
  return apiRequest<LearningResourceDetail>(`/learning/resources/${resourceId}`, {
    headers: bearer(accessToken),
  });
}
...
export function recordResourceEvent(
  ...
  return apiRequest(`/learning/resources/${resourceId}/events`, {
